...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo \ADMIDIO_URL . '/adm_program/modules/registration/asset/css/component_membership.css'; ?>" />
	</head>
	<body>

		<form action="<?php echo \ADMIDIO_URL . '/adm_program/modules/registration/handle_membership.php'; ?>" method="post">
			<h1>Sign Up</h1>
			<!-- -->
