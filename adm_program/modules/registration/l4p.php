...
/**
 *******************************************************************************
 * Custom user adding/password changing
 *
 * @copyright proprietory
 * @license  proprietory
 *******************************************************************************
 */
...
$headline = $gL10n->get('L4P_MEMBERSHIP');
...
if ($usrStatement->rowCount() === 0) {
	...
	$gMessage->show($gL10n->get('L4P_NO_PENDING_MEMBERS'), $gL10n->get('L4P_MEMBERSHIP'));
	# => EXIT
}
