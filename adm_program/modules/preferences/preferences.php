            ...
            <div class="panel panel-default" id="panel_registration">
                ...
                <div id="collapse_registration" class="panel-collapse collapse">
                    <div class="panel-body">');
                        ...
                        $form->addSelectBox('registration_mode', $gL10n->get('SYS_REGISTRATION'), $selectBoxEntries, array('defaultValue' => $form_values['registration_mode'], 'showContextDependentFirstEntry' => false, 'helpTextIdInline' => 'Allow users to sign up or deactivate registration.'));
